...
public class BlockMaterial extends LootPredicate {
    ...
    public String getActiveDescription() {
        return "&fRequires the container to be one of &e" + blocks.stream().map(b -> b.toString().toLowerCase()).collect(Collectors.joining(", "));
    }
