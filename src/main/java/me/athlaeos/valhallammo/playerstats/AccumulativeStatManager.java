...
public class AccumulativeStatManager {
    ...
    static {
        ...
        register("BLOCK_REACH", new ProfileStatSource(PowerProfile.class, "blockReachBonus"), new PotionEffectSource("GENERIC_BLOCK_INTERACTION_RANGE"), new GlobalBuffSource("block_reach"));
        register("STEP_HEIGHT", new ProfileStatSource(PowerProfile.class, "stepHeightBonus"), new PotionEffectSource("GENERIC_STEP_HEIGHT"), new GlobalBuffSource("step_height"));
        register("SCALE", new ProfileStatSource(PowerProfile.class, "scaleMultiplier"), new PotionEffectSource("GENERIC_SCALE"), new GlobalBuffSource("scale"));
