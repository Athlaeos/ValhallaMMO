...
public class ArrowBehaviorDragonFireball extends DynamicItemModifier {
    ...
    public void processItem(Player crafter, ItemBuilder outputItem, boolean use, boolean validate, int timesExecuted) {
        ArrowBehaviorRegistry.addBehavior(outputItem.getMeta(), ArrowBehaviorRegistry.FIREBALL_DRAGON.getName(), radius, incendiary ? 1 : 0);
    }
    ...
    public DynamicItemModifier createNew() {
        return new ArrowBehaviorDragonFireball(getName());
    }
