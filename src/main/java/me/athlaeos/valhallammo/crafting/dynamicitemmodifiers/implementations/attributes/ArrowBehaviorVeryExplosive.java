...
public class ArrowBehaviorVeryExplosive extends DynamicItemModifier {
    ...
    public void processItem(Player crafter, ItemBuilder outputItem, boolean use, boolean validate, int timesExecuted) {
        ArrowBehaviorRegistry.addBehavior(outputItem.getMeta(), ArrowBehaviorRegistry.EXPLODING_REPEATEDLY.getName(), radius, destructive ? 1 : 0, incendiary ? 1 : 0, count);
    }
    ...
    public DynamicItemModifier createNew() {
        return new ArrowBehaviorVeryExplosive(getName());
    }
