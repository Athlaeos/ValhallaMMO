...
public class ArrowBehaviorLargeFireball extends DynamicItemModifier {
    ...
    public void processItem(ModifierContext context) {
        ArrowBehaviorRegistry.addBehavior(context.getItem().getMeta(), ArrowBehaviorRegistry.FIREBALL_LARGE.getName(), radius, incendiary ? 1 : 0);
    }
    ...
    public String getActiveDescription() {
        return String.format("&fTurns the arrow into a large fireball when shot. /n&eBlast Radius: %.1f/n&eIncendiary: %s", radius, incendiary ? "Yes" : "No");
    }
    ...
    public DynamicItemModifier copy() {
        ArrowBehaviorLargeFireball m = new ArrowBehaviorLargeFireball(getName());
