...
public class SmithingTagsRemove extends DynamicItemModifier {
    private final Collection<Integer> tags = new HashSet<>();
    private int tag = 0;

    public SmithingTagsRemove(String name) {
        super(name);
    }
    ...
    public DynamicItemModifier copy() {
        SmithingTagsRemove m = new SmithingTagsRemove(getName());
