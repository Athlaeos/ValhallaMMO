...
public class WeaponChoice extends RecipeOption implements IngredientChoice {
    ...
    public String getActiveDescription() {
        return "The ingredient can be replaced with any weapon of any material";
    }
    ...
    public ItemStack getIcon() {
        ...
        .lore(
            ...
            "&aany weapon of any material. Includes bows,",
            "&acrossbows, and tridents."
        ).get();
    }
    ...
    public String ingredientDescription(ItemStack base) {
        return TranslationManager.getTranslation("ingredient_any_weapon");
    }
}
