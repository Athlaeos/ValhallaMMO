...
public class MerchantAlchemyQualitySet extends DynamicItemModifier {
    ...
    public MerchantAlchemyQualitySet(String name) {
        super(name);
    }
    ...
    public String getDisplayName() {
        return "&eMerchant Alchemy Skill";
    }
    ...
    public DynamicItemModifier copy() {
        MerchantAlchemyQualitySet m = new MerchantAlchemyQualitySet(getName());
