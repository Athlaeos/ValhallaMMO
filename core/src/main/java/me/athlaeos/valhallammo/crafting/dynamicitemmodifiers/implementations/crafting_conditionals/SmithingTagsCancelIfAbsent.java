...
public class SmithingTagsCancelIfAbsent extends DynamicItemModifier {
    private final Collection<Integer> tags = new HashSet<>();
    private int tag = 0;

    public SmithingTagsCancelIfAbsent(String name) {
        super(name);
    }
    ...
    public String getDescription() {
        return "&fIf the item lacks any of the given tags, recipe is cancelled with an error message forwarded to the player. Error messages defined in skills/smithing.yml";
    }
    ...
    public DynamicItemModifier copy() {
        SmithingTagsCancelIfAbsent m = new SmithingTagsCancelIfAbsent(getName());
