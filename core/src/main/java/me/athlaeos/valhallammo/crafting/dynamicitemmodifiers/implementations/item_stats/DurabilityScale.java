...
public class DurabilityScale extends DynamicItemModifier {
    ...
    public DurabilityScale(String name) {
        super(name);
    }
                        ...
                        .get()).map(
                                Set.of(
                                        ...
                                        new Pair<>(0, new ItemBuilder(Material.BOOK)
                                                ...
                                                .lore(String.format("&fCurrent Scaling: &e%s", presetScaling != null ? ModifierScalingPresets.getScalings().get(presetScaling).getExpression() : buildScaling()),
                                                        String.format("&fCurrent Mode: &e%s", presetScaling != null ? ModifierScalingPresets.getScalings().get(presetScaling).getScalingType() : mode),
                                                        "&fSets the stat to scale with a",
                                        ...
                                        new Pair<>(2, new ItemBuilder(Material.REDSTONE_TORCH)
                                                ...
                                                .lore(String.format("&fCurrent Scaling: &e%s", presetScaling != null ? ModifierScalingPresets.getScalings().get(presetScaling).getExpression() : buildScaling()),
                                                        ...
                                                        "&fthe formula to the default stat.",
                                                        "&fMULTIPLIER multiplies the default stat",
    ...
    public String getDisplayName() {
        return "&bScale Durability";
    }

    @Override
    public String getDescription() {
        return "&fScales the item's durability stat according to a defined formula. Items without custom durability will be given custom durability";
    }
    ...
    public DynamicItemModifier copy() {
        DurabilityScale m = new DurabilityScale(getName());
