...
public class MerchantSmithingQualitySet extends DynamicItemModifier {
    ...
    public void processItem(ModifierContext context) {
        ...
        SmithingItemPropertyManager.setQuality(context.getItem(), (int) Math.round(qualityMap.get(level) * (1 + AccumulativeStatManager.getCachedStats("TRADING_SKILL_MULTIPLIER", context.getCrafter(), 10000, true))));
    }
