...
public class OnBlockPlace implements EffectTrigger.ConfigurableTrigger, Listener {
    private static Listener singleListenerInstance = null;

    @Override
    public String id() {
        return "on_block_place_";
    }
    ...
    public String asLore(String rawID) {
        ...
        String[] blocks = args.split("/");
        return "&fPlace any of the following blocks to trigger: " + String.join(", ", blocks);
    }
}
