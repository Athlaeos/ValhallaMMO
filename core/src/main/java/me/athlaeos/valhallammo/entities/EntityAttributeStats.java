...
public class EntityAttributeStats {
    ...
    static{
        ...
        registerAttributeToUpdate(new AttributeDataHolder("valhalla_water_movement_efficiency", WATER_MOVEMENT_EFFICIENCY, "WATER_MOVEMENT_EFFICIENCY_BONUS", AttributeMappings.WATER_MOVEMENT_EFFICIENCY, AttributeModifier.Operation.ADD_NUMBER));
