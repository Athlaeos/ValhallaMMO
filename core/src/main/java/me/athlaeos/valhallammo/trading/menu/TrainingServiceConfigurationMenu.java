...
public class TrainingServiceConfigurationMenu extends SimpleConfigurationMenu<TrainService> implements LayoutConfigurable {
    public TrainingServiceConfigurationMenu(PlayerMenuUtility playerMenuUtility, Menu previousMenu, TrainService thingyToConfigure) {
        ...
        addButton(new Button(13, () -> new ItemBuilder(Material.ANVIL).name("&fSkill to level").lore(
        ...
        addButton(new Button(20, () -> new ItemBuilder(Material.COPPER_INGOT).name("&fLevel limit at Novice").lore(
        ...
        addButton(new Button(21, () -> new ItemBuilder(Material.IRON_INGOT).name("&fLevel limit at Apprentice").lore(
        ...
        addButton(new Button(22, () -> new ItemBuilder(Material.GOLD_INGOT).name("&fLevel limit at Journeyman").lore(
                "&7Currently &e" + thingyToConfigure.getLimitPerLevel().getOrDefault(MerchantLevel.NOVICE, 45),
        ...
        addButton(new Button(23, () -> new ItemBuilder(Material.DIAMOND).name("&fLevel limit at Expert").lore(
        ...
        addButton(new Button(24, () -> new ItemBuilder(Material.NETHERITE_INGOT).name("&fLevel limit at Master").lore(
        ...
        addButton(new Button(38, () -> new ItemBuilder(Material.EXPERIENCE_BOTTLE).name("&fExperience Step").lore(
        ...
        addButton(new Button(39, () -> new ItemBuilder(thingyToConfigure.getCost().getItem())
        ...
        addButton(new Button(41, () -> new ItemBuilder(Material.KNOWLEDGE_BOOK).name("&fSkill Experience Per Level").lore(
                String.format("&7Currently %.1f/order", thingyToConfigure.getSkillExpPerCost() * 100),
        ...
        addButton(new Button(49, () -> new ItemBuilder(Material.BARREL).name("&fEdit Button Position").lore(
