...
public abstract class Service {
    ...
    public abstract void onSelect(InventoryClickEvent e, ServiceMenu menu, MerchantData data);

    public abstract ItemStack getButtonIcon(ServiceMenu serviceMenu, MerchantData data);
