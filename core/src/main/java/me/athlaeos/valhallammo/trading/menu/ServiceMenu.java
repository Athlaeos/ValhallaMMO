...
import me.athlaeos.valhallammo.trading.services.ServiceMenuBuilder;
import me.athlaeos.valhallammo.trading.services.ServiceMenuBuilderImplementation;
...
public class ServiceMenu extends Menu {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (clickedService != null) clickedService.onSelect(e, this, data);
    ...
    public void setMenuItems() {
        ...
        for (int i = 0; i < services.size(); i++){
            ...
            ItemStack baseIcon = service.getButtonIcon(this, data);
