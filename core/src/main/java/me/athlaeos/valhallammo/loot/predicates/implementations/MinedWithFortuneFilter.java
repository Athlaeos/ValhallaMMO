...
public class MinedWithFortuneFilter extends LootPredicate {
    @Override
    public String getKey() {
        return "mined_with_fortune";
    }
    ...
    public String getDisplayName() {
        return "&fMined with Fortune";
    }

    @Override
    public String getDescription() {
        return "&fRequires the block to be mined with Fortune";
    }

    @Override
    public String getActiveDescription() {
        return "&fRequires the block to " + (isInverted() ? "&cNOT&f " : "") + "be mined with Fortune";
    }

    @Override
    public LootPredicate createNew() {
        return new MinedWithFortuneFilter();
    }
    ...
    public boolean test(LootContext context) {
        return context.getLootingModifier() > 0 != inverted;
    }
