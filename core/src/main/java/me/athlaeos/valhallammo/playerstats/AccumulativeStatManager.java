...
public class AccumulativeStatManager {
    ...
    static {
        ...
        registerOffensive("LIGHT_ARMOR_FLAT_IGNORED", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "penetrationFlatLight", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "penetrationFlatLight", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "penetrationFlatLight", WeightClass.LIGHT), new AttributeAttackerSource("LIGHT_ARMOR_PENETRATION_FLAT").penalty("attribute"), new PotionEffectAttackerSource("LIGHT_ARMOR_PENETRATION_FLAT"));
        registerOffensive("LIGHT_ARMOR_FRACTION_IGNORED", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "penetrationFractionLight", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "penetrationFractionLight", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "penetrationFractionLight", WeightClass.LIGHT), new AttributeAttackerSource("LIGHT_ARMOR_PENETRATION_FRACTION").penalty("attribute"), new PotionEffectAttackerSource("LIGHT_ARMOR_PENETRATION_FRACTION"));
        registerOffensive("HEAVY_ARMOR_FLAT_IGNORED", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "penetrationFlatHeavy", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "penetrationFlatHeavy", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "penetrationFlatHeavy", WeightClass.LIGHT), new AttributeAttackerSource("HEAVY_ARMOR_PENETRATION_FLAT").penalty("attribute"), new PotionEffectAttackerSource("HEAVY_ARMOR_PENETRATION_FLAT"));
        registerOffensive("HEAVY_ARMOR_FRACTION_IGNORED", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "penetrationFractionHeavy", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "penetrationFractionHeavy", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "penetrationFractionHeavy", WeightClass.LIGHT), new AttributeAttackerSource("HEAVY_ARMOR_PENETRATION_FRACTION").penalty("attribute"), new PotionEffectAttackerSource("HEAVY_ARMOR_PENETRATION_FRACTION"));
        registerOffensive("ARMOR_FLAT_IGNORED", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "penetrationFlat", WeightClass.WEIGHTLESS), new ArmorPenetrationBreachEnchantmentSource(false), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "penetrationFlat", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "penetrationFlat", WeightClass.LIGHT), new GlobalBuffSource("armor_penetration"), new AttributeAttackerSource("ARMOR_PENETRATION_FLAT").penalty("attribute"), new PotionEffectAttackerSource("ARMOR_PENETRATION_FLAT"));
        registerOffensive("ARMOR_FRACTION_IGNORED", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "penetrationFraction", WeightClass.WEIGHTLESS), new ArmorPenetrationBreachEnchantmentSource(true), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "penetrationFraction", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "penetrationFraction", WeightClass.LIGHT), new GlobalBuffSource("fraction_armor_penetration"), new AttributeAttackerSource("ARMOR_PENETRATION_FRACTION").penalty("attribute"), new PotionEffectAttackerSource("ARMOR_PENETRATION_FRACTION"));
        register("BACK_PROTECTION", new ProfileStatSource(PowerProfile.class, "backDamageReduction"), new AttributeDefenderSource("BACK_PROTECTION"), new PotionEffectSource("BACK_PROTECTION"));
        register("FRONT_PROTECTION", new ProfileStatSource(PowerProfile.class, "frontDamageReduction"), new AttributeDefenderSource("FRONT_PROTECTION"), new PotionEffectSource("FRONT_PROTECTION"));
        register("DAMAGE_ABSORPTION", new ProfileStatSource(PowerProfile.class, "damageAbsorption"), new AttributeDefenderSource("DAMAGE_ABSORPTION"), new PotionEffectSource("DAMAGE_ABSORPTION"));
        ...
        register("ATTACK_DAMAGE_BONUS", new UnarmedDamageBonusSource(), new SetBonusSource("GENERIC_ATTACK_DAMAGE"), new ProfileStatSource(PowerProfile.class, "attackDamageBonus"), new GlobalBuffSource("attack_damage_bonus"), new PotionEffectSource("EXTRA_ATTACK_DAMAGE"));
        ...
        registerOffensive("DAMAGE_DEALT", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "damageMultiplier", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "damageMultiplier", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "damageMultiplier", WeightClass.LIGHT), new AttributeAttackerSource("DAMAGE_ALL").penalty("damage"), new ProfileStatAttackerSource(PowerProfile.class, "attackDamageMultiplier"), new GlobalBuffSource("fraction_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_ALL"));
        ...
        registerOffensive("ANIMAL_DAMAGE_DEALT", new ProfileStatAttackerVictimClassSource(FarmingProfile.class, "butcheryDamageMultiplier", EntityClassification.ANIMAL), new AttributeAttackerSource("DAMAGE_ANIMAL").penalty("damage"), new GlobalBuffSource("fraction_animal_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_ANIMAL"));
        registerOffensive("UNDEAD_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_UNDEAD").penalty("damage"), new GlobalBuffSource("fraction_undead_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_UNDEAD"));
        registerOffensive("ATHROPOD_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_ARTHROPODS").penalty("damage"), new GlobalBuffSource("fraction_arthropods_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_ARTHROPODS"));
        registerOffensive("NETHER_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_NETHER").penalty("damage"), new GlobalBuffSource("fraction_nether_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_NETHER"));
        registerOffensive("OVERWORLD_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_OVERWORLD").penalty("damage"), new GlobalBuffSource("fraction_overworld_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_OVERWORLD"));
        registerOffensive("END_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_END").penalty("damage"), new GlobalBuffSource("fraction_end_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_END"));
        registerOffensive("AQUATIC_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_AQUATIC").penalty("damage"), new GlobalBuffSource("fraction_aquatic_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_AQUATIC"));
        registerOffensive("LIVING_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_LIVING").penalty("damage"), new GlobalBuffSource("fraction_living_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_LIVING"));
        registerOffensive("BOSS_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_BOSS").penalty("damage"), new GlobalBuffSource("fraction_boss_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_BOSS"));
        registerOffensive("ILLAGER_DAMAGE_DEALT", new AttributeAttackerSource("DAMAGE_ILLAGER").penalty("damage"), new GlobalBuffSource("fraction_illager_damage_bonus"), new PotionEffectAttackerSource("DAMAGE_ILLAGER"));
        ...
        registerOffensive("LIGHT_ARMOR_DAMAGE_BONUS", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "damageToLightArmorMultiplier", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "damageToLightArmorMultiplier", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "damageToLightArmorMultiplier", WeightClass.LIGHT), new AttributeAttackerSource("LIGHT_ARMOR_DAMAGE"), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "damageToLightArmorMultiplier", WeightClass.HEAVY));
        registerOffensive("HEAVY_ARMOR_DAMAGE_BONUS", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "damageToHeavyArmorMultiplier", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "damageToHeavyArmorMultiplier", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "damageToHeavyArmorMultiplier", WeightClass.LIGHT), new AttributeAttackerSource("HEAVY_ARMOR_DAMAGE"), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "damageToHeavyArmorMultiplier", WeightClass.HEAVY));
        ...
        // combat related
        registerOffensive("POWER_ATTACK_DAMAGE_MULTIPLIER", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "powerAttackDamageMultiplier", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "powerAttackDamageMultiplier", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "powerAttackDamageMultiplier", WeightClass.LIGHT), new ProfileStatAttackerSource(PowerProfile.class, "powerAttackDamageMultiplier"));
        registerOffensive("POWER_ATTACK_RADIUS", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "powerAttackRadius", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "powerAttackRadius", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "powerAttackRadius", WeightClass.LIGHT), new ProfileStatAttackerSource(PowerProfile.class, "powerAttackRadius"));
        registerOffensive("POWER_ATTACK_DAMAGE_FRACTION", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "powerAttackFraction", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "powerAttackFraction", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "powerAttackFraction", WeightClass.LIGHT), new ProfileStatAttackerSource(PowerProfile.class, "powerAttackFraction"));
        register("ATTACK_REACH_BONUS", new ProfileStatWeightSource(MartialArtsProfile.class, "attackReachBonus", WeightClass.WEIGHTLESS, false), new ProfileStatWeightSource(HeavyWeaponsProfile.class, "attackReachBonus", WeightClass.HEAVY, false), new ProfileStatWeightSource(LightWeaponsProfile.class, "attackReachBonus", WeightClass.LIGHT, false), new AttributeSource("ATTACK_REACH").penalty("attribute"), new ProfileStatSource(PowerProfile.class, "attackReachBonus"), new GlobalBuffSource("attack_reach_bonus"), new PotionEffectSource("ATTACK_REACH"));
        register("ATTACK_REACH_MULTIPLIER", new ProfileStatWeightSource(MartialArtsProfile.class, "attackReachMultiplier", WeightClass.WEIGHTLESS, false), new ProfileStatWeightSource(HeavyWeaponsProfile.class, "attackReachMultiplier", WeightClass.HEAVY, false), new ProfileStatWeightSource(LightWeaponsProfile.class, "attackReachMultiplier", WeightClass.LIGHT, false), new AttributeSource("ATTACK_REACH_MULTIPLIER").penalty("attribute"), new ProfileStatSource(PowerProfile.class, "attackReachMultiplier"), new GlobalBuffSource("attack_reach_multiplier"), new PotionEffectSource("ATTACK_REACH_MULTIPLIER"));
        ...
        registerOffensive("KNOCKBACK_BONUS", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "knockbackMultiplier", WeightClass.WEIGHTLESS), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "knockbackMultiplier", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "knockbackMultiplier", WeightClass.LIGHT), new AttributeAttackerSource("KNOCKBACK").penalty("attribute"), new ProfileStatAttackerSource(PowerProfile.class, "attackKnockbackBonus"), new GlobalBuffSource("knockback_bonus"), new PotionEffectAttackerSource("KNOCKBACK"));
        ...
        registerOffensive("SHIELD_DISARMING", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "shieldDisarming", WeightClass.WEIGHTLESS), new AttributeAttackerSource("SHIELD_DISARMING"), new PotionEffectAttackerSource("SHIELD_DISARMING"), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "shieldDisarming", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "shieldDisarming", WeightClass.LIGHT), new ProfileStatAttackerSource(PowerProfile.class, "shieldDisarming"));
        registerOffensive("LIFE_STEAL", new ProfileStatAttackerWeightSource(MartialArtsProfile.class, "lifeSteal", WeightClass.WEIGHTLESS), new AttributeAttackerSource("LIFE_STEAL"), new PotionEffectAttackerSource("LIFE_STEAL"), new ProfileStatAttackerWeightSource(HeavyWeaponsProfile.class, "lifeSteal", WeightClass.HEAVY), new ProfileStatAttackerWeightSource(LightWeaponsProfile.class, "lifeSteal", WeightClass.LIGHT), new ProfileStatAttackerSource(PowerProfile.class, "lifeSteal"));
        ...
        register("BLOCKING_MOVEMENT_SPEED_BONUS", new AttributeSource("BLOCKING_SPEED").penalty("attribute"), new ProfileStatSource(PowerProfile.class, "blockingMovementSpeedBonus"), new GlobalBuffSource("movement_sprint_blocking"), new PotionEffectSource("BLOCKING_SPEED"));
        ...
        register("SMITHING_QUALITY_COPPER", new ProfileStatSource(SmithingProfile.class, "copperCraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM1", new ProfileStatSource(SmithingProfile.class, "custom1CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM2", new ProfileStatSource(SmithingProfile.class, "custom2CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM3", new ProfileStatSource(SmithingProfile.class, "custom3CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM4", new ProfileStatSource(SmithingProfile.class, "custom4CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM5", new ProfileStatSource(SmithingProfile.class, "custom5CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM6", new ProfileStatSource(SmithingProfile.class, "custom6CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM7", new ProfileStatSource(SmithingProfile.class, "custom7CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM8", new ProfileStatSource(SmithingProfile.class, "custom8CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM9", new ProfileStatSource(SmithingProfile.class, "custom9CraftingSkill"));
        register("SMITHING_QUALITY_CUSTOM10", new ProfileStatSource(SmithingProfile.class, "custom10CraftingSkill"));
        register("SMITHING_QUALITY_OTHER", new ProfileStatSource(SmithingProfile.class, "otherCraftingSkill"));
        ...
        register("SMITHING_FRACTION_QUALITY_COPPER", new ProfileStatSource(SmithingProfile.class, "copperCraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM1", new ProfileStatSource(SmithingProfile.class, "custom1CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM2", new ProfileStatSource(SmithingProfile.class, "custom2CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM3", new ProfileStatSource(SmithingProfile.class, "custom3CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM4", new ProfileStatSource(SmithingProfile.class, "custom4CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM5", new ProfileStatSource(SmithingProfile.class, "custom5CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM6", new ProfileStatSource(SmithingProfile.class, "custom6CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM7", new ProfileStatSource(SmithingProfile.class, "custom7CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM8", new ProfileStatSource(SmithingProfile.class, "custom8CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM9", new ProfileStatSource(SmithingProfile.class, "custom9CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_CUSTOM10", new ProfileStatSource(SmithingProfile.class, "custom10CraftingSkillFractionBonus"));
        register("SMITHING_FRACTION_QUALITY_OTHER", new ProfileStatSource(SmithingProfile.class, "otherCraftingSkillFractionBonus"));
        ...
        register("SMITHING_EXP_GAIN_COPPER", new ProfileStatSource(SmithingProfile.class, "copperEXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM1", new ProfileStatSource(SmithingProfile.class, "custom1EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM2", new ProfileStatSource(SmithingProfile.class, "custom2EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM3", new ProfileStatSource(SmithingProfile.class, "custom3EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM4", new ProfileStatSource(SmithingProfile.class, "custom4EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM5", new ProfileStatSource(SmithingProfile.class, "custom5EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM6", new ProfileStatSource(SmithingProfile.class, "custom6EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM7", new ProfileStatSource(SmithingProfile.class, "custom7EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM8", new ProfileStatSource(SmithingProfile.class, "custom8EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM9", new ProfileStatSource(SmithingProfile.class, "custom9EXPMultiplier"));
        register("SMITHING_EXP_GAIN_CUSTOM10", new ProfileStatSource(SmithingProfile.class, "custom10EXPMultiplier"));
        register("SMITHING_EXP_GAIN_OTHER", new ProfileStatSource(SmithingProfile.class, "otherEXPMultiplier"));
