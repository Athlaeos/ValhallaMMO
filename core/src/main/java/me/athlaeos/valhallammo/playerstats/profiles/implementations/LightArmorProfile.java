...
public class LightArmorProfile extends Profile {
    {
        ...
        floatStat("armorBonusPerPiece", new PropertyBuilder().format(StatFormat.DIFFERENCE_FLOAT_P2).perkReward().create());
        ...
        floatStat("setArmorBonus", new PropertyBuilder().format(StatFormat.DIFFERENCE_FLOAT_P2).perkReward().create());
        ...
        booleanStat("adrenalineUnlocked", new BooleanProperties(true, true));
        intStat("adrenalineLevel", new PropertyBuilder().format(StatFormat.ROMAN).perkReward().create());
        ...
        doubleStat("lightArmorEXPMultiplier", new PropertyBuilder().format(StatFormat.PERCENTILE_BASE_1_P2).perkReward().create());
    }
    ...
    public boolean isAdrenalineUnlocked() { return getBoolean("adrenalineUnlocked"); }
    public void setAdrenalineUnlocked(boolean value) { setBoolean("adrenalineUnlocked", value); }

    public int getAdrenalineLevel() { return getInt("adrenalineLevel"); }
    public void setAdrenalineLevel(int value) { setInt("adrenalineLevel", value); }

    public int getAdrenalineCooldown() { return getInt("adrenalineCooldown"); }
    public void setAdrenalineCooldown(int value) { setInt("adrenalineCooldown", value); }

    public float getAdrenalineThreshold() { return getFloat("adrenalineThreshold"); }
    public void setAdrenalineThreshold(float value) { setFloat("adrenalineThreshold", value); }
