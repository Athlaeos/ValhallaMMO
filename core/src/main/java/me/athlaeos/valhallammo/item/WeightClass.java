...
public enum WeightClass {
    LIGHT("LEATHER_HELMET", "LEATHER_CHESTPLATE", "LEATHER_LEGGINGS", "LEATHER_BOOTS",
            ...
            "TURTLE_HELMET", "WOODEN_SWORD", "STONE_SWORD", "COPPER_SWORD", "IRON_SWORD", "GOLDEN_SWORD",
            "DIAMOND_SWORD", "NETHERITE_SWORD"),
    HEAVY("GOLDEN_HELMET", "GOLDEN_CHESTPLATE", "GOLDEN_LEGGINGS", "GOLDEN_BOOTS",
            "IRON_HELMET", "IRON_CHESTPLATE", "IRON_LEGGINGS", "IRON_BOOTS",
            "NETHERITE_HELMET", "NETHERITE_CHESTPLATE", "NETHERITE_LEGGINGS", "NETHERITE_BOOTS",
            "WOODEN_AXE", "STONE_AXE", "IRON_AXE", "COPPER_AXE", "GOLDEN_AXE", "DIAMOND_AXE",
            "NETHERITE_AXE", "TRIDENT", "MACE", "WOODEN_SPEAR", "STONE_SPEAR", "COPPER_SPEAR", "IRON_SPEAR",
            "GOLDEN_SPEAR", "DIAMOND_SPEAR", "NETHERITE_SPEAR", "COPPER_HELMET", "COPPER_CHESTPLATE",
            "COPPER_LEGGINGS", "COPPER_BOOTS"),
