...
public class PluginTranslationDTO {
    private final Map<String, String> stringTranslations = new HashMap<>(); // Translations based on a string key to string value mapping
    // useful for replacing placeholders in things like items
    private final Map<String, List<String>> stringListTranslations = new HashMap<>(); // Translations based on a string key to a list of strings value mapping
    // useful for inserting lore or whenever the plugin requires several lines of translated stuff
    private final Map<Integer, String> stringIndex = new HashMap<>(); // Indexed lines of text that can be used within things like modifiers to
    // set a new item's lore (single line) or name
    private final Map<Integer, List<String>> stringListIndex = new HashMap<>(); // Indexed lists of text lines that can be used within things like
